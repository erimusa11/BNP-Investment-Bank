...
<div class="row"> 
                                                ...
                                                <div class="form-group col-12">
                                                    <div class="form-line">
                                                        <div class="form-group">
                                                            <input type="text" name="bonifico_data" data-options="{&quot;timepicker&quot;:false, &quot;format&quot;:&quot;d-m-Y&quot;}" class="date-time-picker form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group col-12">
                                                    <div class="form-line">
                                                        <div class="form-group">
                                                            <input type="text" name="bonifico_quantita" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <br>
                                    <br>
                                    <button type="submit" name="bonifico_crea" class="btn btn-md  btn-success ">Registra il bonifico</button>
                            </center>
                            </form>
                        </div>
