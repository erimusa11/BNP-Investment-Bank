                        ...
                        <div class="p-5 col-12 ">
                            <center>
                                <form action="eliminaBonifico.php" method="POST">
                                    <label for="" class="col-6">Seleziona il cliente che cuoi vuoi eleminare ul bonifico</label>
                                    ...
                                    <div class="col-12">
                                        <table class="table table-bordered table-hover data-tables"
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo  date("d-m-Y", strtotime($row_show['bonifico_data']))?></td>
                                                    <td><?php echo  $row_show['bonifico_quantita']."€"?></td>
                                                    
                                                    <td><button type="submit"  name="elemina_bonifico" value="<?php echo $row_show ['bonifico_id']?>" class="btn btn-danger btn-sm">Elimina</button></td>
                                                </tr>
                                                <?php 
                                                        }
                                                    }
