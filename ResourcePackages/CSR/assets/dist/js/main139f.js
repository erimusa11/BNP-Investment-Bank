        ...
        var BNPtoolbox = {
            ...
            filtersToggle: function filtersToggle() {
                ...
                $(".submitFilter").on('click', function () {
                    window.BNPtoolbox.csrArticleSearchResultList.getSearchResult();
                });
            },
            ...
            appendSidebarCustomContent: function appendSidebarCustomContent() {
                // $('.csr-custom-content').appendTo(".mainContentLeft");
                var that = this;

                this.mqHandleAppendSidebarCustom = {
                    match: function() {
                        // that.bindSideBarContentSticky();
                        // $('.mainContentLeft').appendTo(".csr-custom-content");
                        $('.csr-custom-content').appendTo(".mainContentLeft");
                    },
                    unmatch: function() {
                        // that.destroySideBarContentSticky();
                        $('.csr-custom-content').appendTo(".mainContentRight");
                    }
                };
